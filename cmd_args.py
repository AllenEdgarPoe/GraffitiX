...
def parse_args():
    ...
    # Redis Settings
    parser.add_argument('--redis_host', default='127.0.0.1')  #192.168.1.166
    ...
    # AI content Settings
    parser.add_argument('--input_dir', default=os.path.join(base_dir, 'detectmap'))
    parser.add_argument('--output_dir', default=os.path.join(base_dir, 'ensemble_api'))
